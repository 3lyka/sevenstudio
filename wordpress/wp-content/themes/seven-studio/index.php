                ...
                <div class="row hero-wrap d-flex align-items-center">
                    <div class="col-lg-6 sm-padding">
                        <div class="hero-content">
                            ...
                            <div class="btn-group">
                                <a href="#" class="default-btn">Оставить заявку</a>
                                <a href="#" class="play-btn"><i class="fas fa-play"></i>Кейсы</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 sm-padding">
                        <img src="<?php bloginfo('template_url'); ?>/img/hero-1.png" alt="hero">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row content-wrap">
                    ...
                    <div class="col-lg-6 sm-padding wow fadeInRight" data-wow-delay="300ms">
                        <img src="<?php bloginfo('template_url'); ?>/img/content-1.png" alt="content-img">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row content-wrap">
                   <div class="col-lg-6 sm-padding wow fadeInLeft" data-wow-delay="300ms">
                        <img src="<?php bloginfo('template_url'); ?>/img/content-2.png" alt="content-img">
                    </div>
                    <div class="col-lg-6 sm-padding">
                    ...
                    <div class="col-lg-10 offset-lg-1 sm-padding">
                        <div id="project-carousel" class="project-carousel owl-carousel">
                            <div class="project-item">
                                <img src="<?php bloginfo('template_url'); ?>/img/portfolio-1.jpg" alt="img">
                            ...
                            <div class="project-item">
                                <img src="<?php bloginfo('template_url'); ?>/img/portfolio-2.jpg" alt="img">
                                <div class="project-content">
                                    <span>Marketing</span>
                            ...
                            <div class="project-item">
                                <img src="<?php bloginfo('template_url'); ?>/img/portfolio-3.jpg" alt="img">
                                <div class="project-content">
                                    <span>Marketing</span>
                            ...
                            <div class="project-item">
                                <img src="<?php bloginfo('template_url'); ?>/img/portfolio-4.jpg" alt="img">
                                <div class="project-content">
                                    <span>Marketing</span>
                                    <h3><a href="#">Twice profit than before you ever got in business.</a></h3>
                                    <a href="#" class="read-more"><i class="ti-plus"></i></a>
                        ...
                        <div id="testimonial-carousel" class="testimonial-carousel owl-carousel">
                            <div class="testi-item">
                                ...
                                <div class="testi-thumb">
                                    <img src="<?php bloginfo('template_url'); ?>/img/testi-1.jpg" alt="img"><h3>Kyle Frederick<span>Designer</span></h3>
                                </div>
                            </div>
                            <div class="testi-item">
                                <p>"Thank you for guiding us through the construction process, understanding, and always ready to accommodate our needs. We love our new space and know that it was built by the very best!"</p>
                                <div class="testi-thumb">
                                    <img src="<?php bloginfo('template_url'); ?>/img/testi-2.jpg" alt="img"><h3>José Carpio <span>Developer</span></h3>
                                </div>
                            </div>
                            <div class="testi-item">
                                <p>"Thank you for guiding us through the construction process, understanding, and always ready to accommodate our needs. We love our new space and know that it was built by the very best!"</p>
                                <div class="testi-thumb">
                                    <img src="<?php bloginfo('template_url'); ?>/img/testi-3.jpg" alt="img"><h3>Melania Rose <span>Marketer</span></h3>
                                </div>
                            </div>
                        </div>
                    </div>
